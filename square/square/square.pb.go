...
func (x *SquareRequest) GetValue() string {
	if x != nil {
		return x.Value
	}
	return ""
...
func (x *SquareResponse) GetResult() string {
	if x != nil {
		return x.Result
	}
	return ""
...
var file_square_square_proto_rawDesc = []byte{
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x32, 0x4c,
