...
type SquareClient interface {
	...
	CalculateSquare(ctx context.Context, in *SquareRequest, opts ...grpc.CallOption) (*SquareResponse, error)
}
...
func (c *squareClient) CalculateSquare(ctx context.Context, in *SquareRequest, opts ...grpc.CallOption) (*SquareResponse, error) {
	out := new(SquareResponse)
	err := c.cc.Invoke(ctx, "/square.Square/CalculateSquare", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SquareServer interface {
	// RPC call to send a square request and get the response in return
	CalculateSquare(context.Context, *SquareRequest) (*SquareResponse, error)
...
func (UnimplementedSquareServer) CalculateSquare(context.Context, *SquareRequest) (*SquareResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CalculateSquare not implemented")
}
...
func _Square_CalculateSquare_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SquareRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SquareServer).CalculateSquare(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/square.Square/CalculateSquare",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SquareServer).CalculateSquare(ctx, req.(*SquareRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Square_CalculateSquare_Handler,
		},
	},
